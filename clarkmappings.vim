...
" Html mappings
  ...
  " Html Inputs
    ...
    " Html Input CAlendar
    nmap <silent> ,hica a<%= ChangeForm_form.text_field(<return>  :ChangeAttribute,<return>class: 'form-control datetimepicker',<return>data: { 'min-view': '2', 'date-format': 'MM dd, yyyy' },<return>onclick: "removeInlineCalendarsAfterAjax()",<return><esc>,hiat) %><return><esc>,mmessagehtmlinputcalendar<esc>/ChangeForm\\|ChangeAttribute\\|ChangeValue\\|DeleteThis<return>
    " Html Input Calendar with Button
    nmap <silent> ,hicb a<div class="input-group date datetimepicker" data-min-view="2" data-date-format="DD, MM dd, yyyy"><return><%= ChangeForm_form.text_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return>onclick: "removeInlineCalendarsAfterAjax()",<return><esc>,hiat) %><return><space><space><div class="input-group-append"><return><a class="btn btn-primary cal-button do-not-disable" onclick="removeInlineCalendarsAfterAjax()"><i class="icon-th mdi mdi-calendar"></i></a><return></div><return></div><return><esc>,mmessagehtmlinputcalendar<esc>/ChangeForm\\|ChangeAttribute\\|ChangeValue\\|DeleteThis<return>
    nnoremap <silent> ,mmessagehtmlinputcalendar a<%# DeleteThis - value of nil or if value is excluded, text box will be blank and calendar defaults to today. If a value is included, make sure it is a date, not a date time and include correct strftime %><return><%# DeleteThis - min-view: 0 is 5 minutes; 1 is hour; 2 is date %><return><%# DeleteThis - date-format: MM is January; mm is 01; DD is Monday (day of week); dd is 01 (day of month) %><return><%# DeleteThis - see https://xdsoft.net/jqplugins/datetimepicker/ for more options %>
    " Html Input Errors
...
" ruby mappings
  ...
  " Ruby model mappings
    ...
    nnoremap <silent> ,rmvd avalidates :ChangeAttribute, dependent_on: { independent_path: %i[ChangeMethods],<return>dependent_path: %i[ChangeMethods],<return>if_independent_is: [ChangeValues],<return>if_independent_is_not: [ChangeValues],<return>dependent_must_be: [ChangeValues],<return>dependent_cannot_be: [ChangeValues],<return>equal_values: true,<return>not_equal_values: true,<return>message: 'ChangeMessage' }<return># DeleteThis - dependent_path is optional<return>DeleteThis - can only have if_independent_is OR if_independent_is_not<return>DeleteThis - can only have dependent_must_be OR dependent_cannot_be OR equal_values OR not_equal_values<return>DeleteThis - custom message is optional<esc>/ChangeAttribute\\|ChangeMethods\\|ChangeValues\\|ChangeMessage\\|DeleteThis<return>
