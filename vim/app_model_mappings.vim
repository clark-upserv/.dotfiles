" Base / Misc
  ...
  nnoremap <silent> ,amcn acan %i[ChangeAbility], :ChangeNamespace_ChangeControllerOrFeature<return># DeleteThis - ChangeAbility - use "manage" or some specific controller action<return>DeleteThis - ChangeNamespace - the upserv "app" this ability belongs to (ex. "core" or "hr", etc.)<return>DeleteThis - ChangeControllerOrFeature - a specific controller or a feature that describes a collection of<return>controllers.<esc>/ChangeAbility\\|ChangeNamespace\\|ChangeControllerOrFeature\\|DeleteThis<enter>
...
" Validations
  ...
  nnoremap <silent> ,amvu avalidates :ChangeAttribute, uniqueness: {<return>case_sensitive: false,<return>scope: %i[ChangeAttributes],<return>message: 'The ChangeAttribute "%<attribute>s" has already been taken'<return><space><backspace><esc>:call AppModelsValidatesMessage()<return>a}<esc>:call RubyModlesValidatesOptions()<return>:call AppModelsValidatesSearch()<return>
