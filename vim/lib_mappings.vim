...
" Lib Filter helper
  ...
  nnoremap <silent> ,lfba :call CreateBaseFile(1, 0, 1)<return>:call IndentTemplate('inner_followup', 1, 0, '../templates/lib/filter_helpers/base.rb')<return>/ChangeTopLevelDocumentation<return><down>$viwy/ChangeTopLevelDocumentation<return>viwpbiFilter helper for <esc>A controller<esc>0/FilterHelper<return>cgn<esc>gg/ChangeModel\\|ChangeAbility\\|ChangeQueryScope\\|DeleteThis\\|ChangeFilter\\|ChangeDisplay\\|ChangeScopeArg\\|ChangeChain\\|ChangeArgs\\|ChangeOption\\|ChangeAdditionalScopes\\|ChangeOrder<return>
