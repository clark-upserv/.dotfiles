...
" Html Single Item Image partial
 nnoremap <silent> ,hsiI a<%= form_with(scope: 'ChangeScope', url: ChangePath_path(ChangeObject), method: :ChangeMethod) do \|sii_form\| %><return><%= sii_form.label(:ChangeAttribute, class: 'm-0') do %><return><i class="c-pointer icon px-3 fs-4 text-secondary mdi mdi-camera"></i><return><% end %><return><%= sii_form.file_field(<return><tab>:ChangeAttribute,<return>data: { siiId: 'ChangeSiiId' },<return>class: 'd-none',<return>accept: 'image/*',<return># DeleteThis - limit to specific types of images by updating accept attribute<return>DeleteThis - common formats are: image/jpeg image/gif image/png image/heic<return>DeleteThis - keep image/* for now until I do more research and test different types.<return><backspace><backspace>multiple: ChangeToTrueOrRemove<return>) %><return><tab><%= render(<return><tab>'shared/single_input_images_modal',<return>siiId: 'ChangeSiiId',<return>title: 'Changetitle',<return># DeleteThis - Change title... typically "Preview Photo" or "Preview Photos" if mulitiple<return><backspace><backspace>images_container_html_attributes: 'class="d-flex flex-wrap align-items-center justify-content-around"',<return># DeleteThis - add html attributes manually as needed. Html id automatically set to ChangeSiiId_images<return><backspace><backspace>img_html_attributes: 'data-class="img_rounded_corners m-2" data-width="250" data-height="auto"',<return># DeleteThis - add html attributes manually via data attributes. Html id, src and alt set automatically<return><backspace><backspace>form: sii_form<return>)%><return><% end %><esc>/ChangeScope\\|ChangePath\\|ChangeObject\\|ChangeMethod\\|ChangeAttribute\\|ChangeToTrueOrRemove\\|ChangeSiiId\\|Changetitle\\|DeleteThis<return>
...
" Html Form items / inputs
  ...
  function! HtmlInputSearch()
    let @/ = "ChangeFormObject\\|ChangeForm\\|ChangeObject\\|ChangeAttribute\\|ChangeValue\\|ChangeOptionsList\\|# DeleteOrUseThis - \\|DeleteThis\\|MakeTrueOrRemoveThisLine\\|ChangeOptionObjects\\|ChangeOptionObject\\|ChangeDisplay\\|ChangeScope\\|ChangePath\\|ChangeMethod\\|ChangeSesId\\|ChangeRange"
    normal! n
  endfunction
  " Html Form Buttons (cancel & submit) - Buttons 
  nnoremap <silent> ,hfbb a<%# Form buttons %><return><div class="d-flex justify-content-end"><return><a class="btn btn-secondary mr-3 ChangeSesId-ses-cancel-button">Cancel</a><return><%= ChangeForm_form.submit 'AddForCreateOrSaveForUpdate', class: "btn btn-primary" %><return></div><esc>/ChangeSesId\\|ChangeForm\\|AddForCreateOrSaveForUpdate<return>
  ...
  nnoremap <silent> ,hfda a<%= ChangeForm_form.date_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Time Field
  nnoremap <silent> ,hfti a<%= ChangeForm_form.time_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form date time Local Field
  nnoremap <silent> ,hfdt a<%= ChangeForm_form.datetime_local_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Month Field
  nnoremap <silent> ,hfmo a<%= ChangeForm_form.month_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Week Field
  nnoremap <silent> ,hfwe a<%= ChangeForm_form.week_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Range Field
  nnoremap <silent> ,hfra a<%= ChangeForm_form.range_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return>in: ChangeRange,<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Search Field
  nnoremap <silent> ,hfse a<%= ChangeForm_form.search_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Telephone Field
  nnoremap <silent> ,hftp a<%= ChangeForm_form.telephone_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Url Field
  nnoremap <silent> ,hfur a<%= ChangeForm_form.url_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Color Field
  nnoremap <silent> ,hfco a<%= ChangeForm_form.color_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return><esc>:call HtmlInputMainAttributes()<return>o) %><esc>:call HtmlInputSearch()<return>
  " Html Form Email Field
  nnoremap <silent> ,hfem a<%= ChangeForm_form.email_field(<return>  :ChangeAttribute,<return>value: ChangeValue,<return>class: 'form-control',<return>autofocus: true,<return>autocomplete: 'email',<return>placeholder: 'Enter ChangePlaceholder',<return>required: true,<return>size: 'ChangeSize',<return>maxlength: 'ChangeMaxLength'<return>) %><esc>/ChangeForm\\|ChangeAttribute\\|ChangeValue\\|'email'\\|ChangePlaceholder\\|ChangeSize\\|ChangeMaxLength<return>
  " Html Form Password field
  nnoremap <silent> ,hfpa a<%= ChangeForm_form.password_field(<return>  :ChangeAttribute,<return>class: 'form-control',<return>autofocus: true,<return>placeholder: 'Enter ChangePlaceholder',<return>required: true,<return>size: ChangeSize,<return>minlength: ChangeMinLength) %><esc>/ChangeAttribute\\|ChangeForm\\|ChangePlaceholder\\|ChangeSize\\|ChangeMinLength<return>
  " Html Form Rich Text
  ...
  " Html Form TOggle
  nnoremap <silent> ,hfto :call IndentTemplate('', 1, 0, '../templates/views/elements/toggle.html.erb')<return>/ChangeForm\\|ChangeColor\\|switch-button-yesno\\|DeleteThis\\|ChangeAttribute<return>
  ...
  nnoremap <silent> ,hfsm a<%= ChangeForm_form.select(<return>  :ChangeAttribute,<return>ChangeOptionsList,<return><space><backspace><esc>:call HtmlInputSelectValueNote()<return>a{ include_hidden: false },<return><space><backspace><esc>:call HtmlInputSelectMultipleOptionsNote()<return>a{<return><tab>class: 'form-control',<return>multiple: true,<return>required: MakeTrueOrRemoveThisLine,<return>autofocus: MakeTrueOrRemoveThisLine<return><backspace>)<backspace>})<return>%><esc>:call HtmlInputSearch()<return>
  ...
  nnoremap <silent> ,hfni a<span id="ChangeDisplayId" class="ses-non-input-input"><%= ChangeDisplay %></span><return><%= ChangeForm_form.hidden_field(:ChangeAttribute, id: 'ChangeHiddenInputId', value: ChangeValue) %><esc>/ChangeDisplayId\\|ChangeDisplay\\|ChangeForm\\|ChangeAttribute\\|ChangeHiddenInputId\\|ChangeValue<return>
  " Html Form SUbmit
  nnoremap <silent> ,hfsu a<%= ChangeForm_form.submit('ChangeDisplay', class: 'btn btn-ChangeColor') %><esc>/ChangeForm\\|ChangeDisplay\\|ChangeColor<return>
  " Html Form Submit Link
  nnoremap <silent> ,hfsl a<%= ChangeForm_form.submit('ChangeDisplay', class: 'btn-link') %><esc>/ChangeForm\\|ChangeDisplay<return>
