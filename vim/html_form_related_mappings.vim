...
" Html Form
  " Html Form BAse
  nnoremap <silent> ,hfba a<%= form_with(model: ChangeObject, scope: 'ChangeScope', url: ChangeUrl_path, method: :ChangeHTMLMethod) do \|ChangeForm_form\| %><return><return><%# DeleteThis - insert hidden fields here if necessary %><return><%# DeleteThis - insert label type (or fields for if necessary) %><return><%# DeleteThis - insert form buttons %><return><return><% end %><esc>/ChangeObject\\|ChangeScope\\|ChangeUrl\\|ChangeHTMLMethod\\|ChangeForm\\|DeleteThis<return>
...
" Html Inputs
  ...
  function! HtmlInputSearch()
    let @/ = "ChangeFormObject\\|ChangeForm\\|ChangeObject\\|ChangeAttribute\\|ChangeValue\\|ChangeOptionsList\\|DeleteThis\\|MakeTrueOrRemoveThisLine\\|ChangeOptionObjects\\|ChangeOptionObject\\|ChangeDisplay\\|ChangeScope\\|ChangePath\\|ChangeMethod\\|ChangeSesId"
    normal! n
  endfunction
